...
<body>
	<div class="login-wrap cover">
		<div class="container-login">
			...
			<p class="text-center text-condensedLight">Acceso al inventario de ACUATICOS EC.</p>
			<form action="loginValidacion.php" method="POST">
				<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
				    <input class="mdl-textfield__input" type="email" id="userName" name="correo">
				    <label class="mdl-textfield__label" for="userName">Correo del Usuario</label>
				</div>
				<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
